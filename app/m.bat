...
sdcc -mz80 --no-std-crt0 --opt-code-speed --nostdlib --code-loc 0x6032 --data-loc 0xc000 -Wl -b_HEADER=0x6000 crt0.rel app.rel sound.rel
..\tools\ihx2bin crt0.ihx app.bin
